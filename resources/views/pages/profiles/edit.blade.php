        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    <a href="{{route('profiles.show', $profile)}}" class="btn btn-primary">Public View</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h5>Edit your Profile from here</h5>
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal"
                                action="{{ route('profiles.update', $profile) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="email" class="form-control @error('password') is-invalid @enderror"
                                            name="email" disabled value="{{ $profile->email }}" required autocomplete="email">
                                        @error('email')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
