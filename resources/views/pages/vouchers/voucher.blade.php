        ...
        <tr>
            <td>
                <table class="fullWidth voucherBorder">
                    ...
                    <tr>
                        <th style="font-size: 25px;">The Spirit School</th>
                    </tr>
                    ...
                    <tr class="centerAlign">
                        <td class="bottomLine">pr.lhr.kna@tss.edu.pk</td>
                    </tr>
                    ...
                    <tr class="centerAlign">
                        <td class="bottomLine">
                            <table class="fullWidth">
                                <tr>
                                    <td class="leftAlign"><b>Reg. No:</b>220300001</td>
                                    <td class="rightAlign"><b>Voucher:</b>23463463456</td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="leftAlign"><b>Student:</b>Hamza Saqib</td>
                                </tr>
                                <tr>
                                    <td class="leftAlign"><b>Class:</b> Nine</td>
                                    <td class="rightAlign"><b>Academic Year:</b> 2022</td>
                                </tr>
                                <tr>
                                    <td class="leftAlign"><b>Issued Date:</b>28-23-22</td>
                                    <td class="rightAlign"><b>Due Date:</b>30-02-22</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
