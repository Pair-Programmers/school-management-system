...
@section('title-meta')
    <title>{{ config('app.name') }} | Section Edit</title>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="{{ route('classes.index') }}">Sections</a>
                    </li>
                    <li class="active">
                        <strong>Edit</strong>
                    </li>
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    <a href="{{ route('sections.index') }}" class="btn btn-primary">Show List</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="POST" class="form-horizontal" action="{{ route('sections.update', $section) }}"
